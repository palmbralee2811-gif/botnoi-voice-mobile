            ...
            children: [
              GradientTextAlign(
                ...
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize:
                      ResponsiveDesignOrientation.isLandscape ? 16.sp : 22.sp,
              ...
              SizedBox(height: 8.h),
              GradientTextAlign(
                'delete_account.account_deletion_warning'
                    .tr(), //การลบบัญชีเป็นการกระทำที่ไม่สามารถย้อนกลับได้ คุณจะไม่สามารถใช้บัญชีนี้กับผลิตภัณฑ์และบริการ พ้อยท์คงเหลือหรือแพ็คเกจที่สมัคร สิทธิพิเศษและโปรโมชั่นที่ได้รับอีกต่อไป โปรดระมัดระวัง
                gradient: const LinearGradient(
                  colors: [
                    Color(0xFF9340FF),
                    Color(0xFF34BDFA),
              ...
              Center(
                child: Column(
                  children: [
                    GradientTextAlign(
                      'delete_account.confirm_account_deletion'
                          .tr(), //หากยืนยันที่จะลบบัญชีต่อ กรุณากดปุ่ม
                      gradient: const LinearGradient(
                        colors: [
                          Color(0xFF9340FF),
                          Color(0xFF34BDFA),
                    ...
                    GradientTextAlign(
                      'delete_account.confirm_account_deletion_below'
                          .tr(), //"ยืนยันลบบัญชี" ด้านล่าง
                      gradient: const LinearGradient(
                        colors: [
                          Color(0xFF9340FF),
                          Color(0xFF34BDFA),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  padding: EdgeInsets.symmetric(
                      vertical:
                          ResponsiveDesignOrientation.isLandscape ? 6.h : 12.h),
