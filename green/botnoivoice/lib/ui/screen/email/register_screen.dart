...
import 'package:botnoivoice/ui/widget/button/line_login_button.dart';
import 'package:botnoivoice/ui/dialog/email_permission/email_permission_dialog.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _registerUser() async {
    final emailRegisterProvider =
        Provider.of<EmailRegister>(context, listen: false);
