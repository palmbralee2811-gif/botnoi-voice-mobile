...
class WorkspaceInputTextWidget extends StatefulWidget {
  final String initialSentences;
  final Function(String) onSentencesChanged;

  const WorkspaceInputTextWidget({
    super.key,
  ...
  @override
  _WorkspaceInputTextWidgetState createState() => _WorkspaceInputTextWidgetState();
}

class _WorkspaceInputTextWidgetState extends State<WorkspaceInputTextWidget> {
  late TextEditingController textController = TextEditingController();
  
  @override
  void initState() {
    textController = TextEditingController(text: widget.initialSentences);
    super.initState();
  }
  @override
  void dispose() {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
              onPressed: (){
              widget.onSentencesChanged(textController.text);
            }, 
