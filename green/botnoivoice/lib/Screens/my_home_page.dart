...
import 'package:botnoivoice/Screens/HomeScreen/drawer_appbar.dart';
// import 'package:botnoivoice/backend.dart';
  ...
  class _MyHomePageState extends State<MyHomePage> {
    ...
    Future<void> fetchDataFromBackend() async {
      ...
      if (listProjects.isNotEmpty) {
        ...
        List<Map<String, String>> fetchedSpeakerDetails = await auth.fetchImageUrl(speakerIds);
