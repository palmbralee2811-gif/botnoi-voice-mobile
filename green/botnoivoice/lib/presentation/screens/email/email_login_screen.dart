          ...
          child: Center(
            child: SingleChildScrollView(
              child: Padding(
                ...
                left: isLandscape ? 38.w : 24.w, 
                right: isLandscape ? 38.w : 24.w),
                child: Form(
                  key: _formKey,
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: isLandscape ? 22.h : 32.h),
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          errorStyle:
                              TextStyle(fontSize: isLandscape ? 10.sp : 14.sp),
                          errorMaxLines: 5,
                      ...
                      SizedBox(height: isLandscape ? 14.h : 16.h),
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            icon: Icon(
                              ...
                              size:
                                  isLandscape ? 16.w : 24.w, // Adjust icon size
                            ),
                            onPressed: () {
                              setState(() {
                      ...
                      SizedBox(height: isLandscape ? 14.h : 12.h),
                      _isLoading
                          ? const Center(
                              child:
                      ...
                      SizedBox(height: isLandscape ? 13.h : 16.h),
                      Row(
                        children: [
                          const Expanded(
                            child: Divider(
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            left: isLandscape ? 40.w : 15.w,
                            right: isLandscape ? 40.w : 15.w),
                      ...
                      SizedBox(height: isLandscape ? 100.h : 140.h),
                    ],
                  ),
                ),
              ),
