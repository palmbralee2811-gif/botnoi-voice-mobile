            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GradientTextAlign(
                    'change_email_username.change_username'.tr(), //เปลี่ยนชื่อผู้ใช้
                  ...
                  SizedBox(height: 8.h),
                  GradientTextAlign(
                    'change_email_username.set_new_username_for_login'.tr(), //ตั้งชื่อผู้ใช้งานใหม่สำหรับใช้ในการเข้าสู่ระบบ
                    gradient: const LinearGradient(
                      colors: [
                        Color(0xFF9340FF),
                        Color(0xFF34BDFA),
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'change_email_username.please_enter_your_username'.tr(); //โปรดใส่ชื่อผู้ใช้งานของคุณ
                      }
                      if (!isValidUsername(value.trim())) {
                        return 'change_email_username.invalid_username'.tr(); //ชื่อผู้ใช้งานไม่ถูกต้อง กรุณาใช้ตัวอักษร a-z, A-Z, ตัวเลข และเครื่องหมาย _ หรือ -
                      }
                      return null;
                    },
                  ),
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'change_email_username.please_confirm_your_username'.tr(); //โปรดยืนยันชื่อผู้ใช้งานของคุณ
                      }
                      if (!isValidUsername(value.trim())) {
                        return 'change_email_username.invalid_username'.tr(); //ชื่อผู้ใช้งานไม่ถูกต้อง กรุณาใช้ตัวอักษร a-z, A-Z, ตัวเลข และเครื่องหมาย _ หรือ -
                      }
