...
// /// Apple: Token, User Profile Data and Credentials
// class AppleToken extends ChangeNotifier {
//   String? _userID;
//   String? _userName;
//   String? _jwtToken;
...
/// Apple: Token, User Profile Data and Credentials using Riverpod StateNotifier.
class AppleTokenNotifier extends StateNotifier<UserTokenState> {
  final Ref _ref;
  final Logger _logger = Logger(); // For debugging

  AppleTokenNotifier(this._ref) : super(UserTokenState());
  ...
  Future<void> loadJwtToken() async {
    // Get the AppleLoginNotifier instance via ref
    final appleLoginNotifier = _ref.read(appleLoginNotifierProvider.notifier);
    // Get the idToken from the Authentication provider
    String? idToken = await appleLoginNotifier.user?.getIdToken();
...
/// Riverpod provider for AppleTokenNotifier.
final appleTokenNotifierProvider = StateNotifierProvider<AppleTokenNotifier, UserTokenState>((ref) {
  return AppleTokenNotifier(ref);
});