              ...
              child: Column(
                children: [
                  Container(
                    ...
                    height: ResponsiveDesignOrientation.isLandscape ? 313.h : 100.h,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    isSelected
                                        ? Container(
                                            width: 31.w,
                                            height: ResponsiveDesignOrientation.isLandscape ? 30.h : 17.h,
                                            decoration: BoxDecoration(
                                              ...
                                              borderRadius: BorderRadius.circular(
                                                  ResponsiveDesignOrientation.isLandscape ? 16.r : 8.r),
                                            ),
                                            child: Center(
                                              child: Text(
                                                'select'.tr(),
                                                style: TextStyle(
                                                  ...
                                                  fontSize: ResponsiveDesignOrientation.isLandscape ? 6.sp : 8.sp,
                                    ...
                                    GestureDetector(
                                      onTap: () => onFavoriteToggle(speakerItem.speakerId),
                                      child: isFavorite
                                          ? ShaderMask(
                                              ...
                                              child: SvgPicture.asset(
                                                ...
                                                width: ResponsiveDesignOrientation.isLandscape ? 50.w : 20.w,
                                                height: ResponsiveDesignOrientation.isLandscape ? 50.h : 20.h,
                                              ),
                                            )
                                          : SvgPicture.asset(
                              ...
                              const Spacer(), // Replaced with SizedBox for controlled spacing
                              Padding(
                                    ...
                                    isSelected
                                        ? ShaderMask(
                                            ...
                                            child: SvgPicture.asset(
                                              ...
                                              width: ResponsiveDesignOrientation.isLandscape ? 12.h : 16.h,
                                              height: ResponsiveDesignOrientation.isLandscape ? 12.w : 16.w,
                                            ),
                                          )
                                        : SvgPicture.asset(
                              ...
                              SizedBox(height: 4.h), // Controlled bottom spacing
                            ],
                          ),
                        ),
                      ],
