...
import 'package:botnoi_voice_mobile/Screens/WorkspaceScreen/gredient_border_painter.dart';
import 'package:flutter/material.dart';

class WorkspaceAddButtonWidget extends StatelessWidget {
  const WorkspaceAddButtonWidget({super.key});
  @override
  Widget build(BuildContext context) {
    double borderRadius = 10;
    final List<Color> gradientColors = [
      const Color.fromARGB(255, 242, 124, 255),
      const Color.fromARGB(255, 31, 195, 255),
    ];
        ...
        child: Container(
          decoration: BoxDecoration(
            color: const Color.fromARGB(255, 227, 227, 227)
                .withOpacity(0.3), // Slightly grey and transparent background
            ...
            label: ShaderMask(
              ...
              child: const Text(
                ...
                style: TextStyle(
                  color: Colors.white,
                  fontFamily:
                      'Prompt', // This color will be overridden by ShaderMask
                  fontSize: 16,
                ),
              ),
            ),
