...
import 'package:botnoi_voice_mobile/Database/data.dart';
import 'package:botnoi_voice_mobile/Function/randomString.dart';
import 'package:botnoi_voice_mobile/Model/models.dart';
...
import 'package:botnoi_voice_mobile/Widgets/HomeWidget/favorite_voice_widget.dart';
import 'package:botnoi_voice_mobile/Widgets/WorkspaceWidget/workspace_appbar_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _iOSDownloadFunction() async {
    try {
      ...
      if (response.statusCode == 200) {
        String filename =
            "botnoi_voice_mobile${randomString(6)}.$selectedTypeMedia";
  ...
  Future<void> _androidDownloadFunction() async {
    try {
      var filename = "botnoi_voice_mobile${randomString(6)}.$selectedTypeMedia";
