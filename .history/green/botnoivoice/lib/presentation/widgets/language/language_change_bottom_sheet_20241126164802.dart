...
class _LanguageChangeBottomSheetLoginState
  ...
  bool isExpanded = false; // Track whether the bottom sheet is expanded or not
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        ...
        // Show the language bottom sheet when tapped
        ...
        // Close the bottom sheet and reset the expanded state
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            // Display the arrow icon (up or down) based on expanded state
            Icon(
              isExpanded
