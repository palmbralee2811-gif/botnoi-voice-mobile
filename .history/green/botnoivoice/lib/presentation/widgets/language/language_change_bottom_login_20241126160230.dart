...
class _LanguageChangeBottomSheetState
  ...
  final List<Map<String, String>> _languageOptions = [
    {
      'language': 'th',
      'label': 'ไทย',
      'icon': 'assets/images/national_flag/thai.png'
    }, // Thai flag path
    {
      'language': 'en',
      'label': 'English',
      'icon': 'assets/images/national_flag/english.png'
    }, // English flag path
  ];
  ...
  _onLanguageSelected(String language) {
    ...
    // Navigate to a new page (BotnoiVoiceApp) after language change
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
          builder: (context) =>
              const BotnoiVoiceApp()), // Your app's entry point or home page
    );
  }
