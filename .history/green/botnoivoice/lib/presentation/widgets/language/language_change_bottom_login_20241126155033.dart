...
class _LanguageChangeBottomSheetState extends State<LanguageChangeBottomSheet> {
  ...
  final List<Map<String, String>> _languageOptions = [
    {'language': 'th', 'label': 'thai', 'icon': 'assets/images/national_flag/thai.png'}, // Thai flag path
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  // Use the 'language' key for the title
                  Text(
                    'language'.tr(), // This is now translatable
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 20.w),
                        // Use 'thai' and 'english' keys for the language labels
                        Text(
                          language['label']!.tr(), // This uses the translated key for 'thai' or 'english'
                          style: GoogleFonts.prompt(
                            fontSize: 14.sp,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            // Use 'thai' and 'english' keys for the language labels
            Text(
              _selectedLanguage == 'th' ? 'thai'.tr() : 'english'.tr(), // Translate 'thai' or 'english' key
              style: GoogleFonts.prompt(
                fontSize: 16.sp,
                fontWeight: FontWeight.w600,
              ),
