...
import 'package:botnoivoice/presentation/widgets/language/language_change_bottom_sheet_app_drawer.dart'; // Your language selection function
...
class _LanguageChangeBottomSheetLoginState
  ...
  void _onLanguageSelected(String languageCode) {
    context.setLocale(Locale(languageCode == 'th' ? 'th' : 'en', languageCode == 'th' ? 'TH' : 'US'));
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                      builder: (BuildContext context) =>
                          const HomeScreen(), // Replace with your current page widget
                    ),
                  );
                },
                child: Container(
