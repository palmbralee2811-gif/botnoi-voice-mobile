          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'เพื่อให้คุณสามารถใช้งานฟีเจอร์การกู้คืนรหัสผ่านและให้เราสามารถแจ้งเตือนเกี่ยวกับข้อมูลข่าวสารที่สำคัญที่เกี่ยวข้องกับการใช้งานแอปของคุณตามเงื่อนไขการเก็บข้อมูลอีเมลของคุณ โดยข้อมูลนี้จะถูกเก็บรักษาอย่างปลอดภัยและไม่ใช้เพื่อวัตถุประสงค์ทางโฆษณาโดยไม่ได้รับความยินยอม', //เพื่อให้คุณสามารถใช้งานฟีเจอร์การกู้คืนรหัสผ่านและให้เราสามารถแจ้งเตือนเกี่ยวกับข้อมูลข่าวสารที่สำคัญที่เกี่ยวข้องกับการใช้งานแอปของคุณตามเงื่อนไขการเก็บข้อมูลอีเมลของคุณ โดยข้อมูลนี้จะถูกเก็บรักษาอย่างปลอดภัยและไม่ใช้เพื่อวัตถุประสงค์ทางโฆษณาโดยไม่ได้รับความยินยอม
                  style: GoogleFonts.prompt(
                    fontSize: 14.sp,
                ...
                SizedBox(height: 12.h),
                Text(
                  'คุณสามารถยกเลิกการอนุญาตได้ในภายหลัง', //คุณสามารถยกเลิกการอนุญาตได้ในภายหลัง
                  style: GoogleFonts.prompt(
                    fontSize: 14.sp,
                    fontWeight: FontWeight.w400,
                    color: kDark,
