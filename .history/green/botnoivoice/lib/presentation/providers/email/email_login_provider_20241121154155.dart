    ...
    try {
      ...
      switch (e.code) {
        ...
        case 'wrong-password':
          ...
          break;
        case 'user-disabled':
          _errorMessage = 'app_drawer.account_suspended'.tr(); //บัญชีนี้ถูกระงับการใช้งาน
          break;
        default:
          _errorMessage = 'app_drawer.username_or_password_incorrect'.tr(); //ชื่อผู้ใช้งานหรือรหัสผ่านไม่ถูกต้อง
          break;
      }
      _logger.e(
