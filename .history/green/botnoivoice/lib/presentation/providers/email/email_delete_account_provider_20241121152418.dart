...
class EmailDeleteAccountProvider with ChangeNotifier {
  ...
  Future<bool> verifyPassword(String password) async {
    ...
    if (isPasswordProviderUser(user)) {
      try {
        ...
        switch (error.code) {
          case 'wrong-password':
            ...
            break;
          default:
            _errorMessage = "เกิดข้อผิดพลาดในการยืนยันรหัสผ่าน"; //เกิดข้อผิดพลาดในการยืนยันรหัสผ่าน
            break;
        }
        _logger.e(
      ...
      _errorMessage = "ไม่ได้เข้าสู่ระบบด้วยชื่อผู้ใช้งานและรหัสผ่าน"; //ไม่ได้เข้าสู่ระบบด้วยชื่อผู้ใช้งานและรหัสผ่าน
