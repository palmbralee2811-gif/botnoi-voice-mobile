...
class LoginScreen extends StatelessWidget {
          ...
          child: GestureDetector(
            onTap: () {
              ...
              showLanguageBottomSheetLogin(
                context: context,
                selectedLanguage: 'th', // default selected language
                onLanguageSelected: (language) {
                  // Handle language selection
                  context.setLocale(Locale(language, language.toUpperCase()));
                },
              );
            },
  ...
  void showLanguageBottomSheetLogin({required BuildContext context, required String selectedLanguage, required Null Function(dynamic language) onLanguageSelected}) {}
}
