...
InkWell(
  onTap: () {
    ...
    showLanguageBottomSheet(
      context: context,
      selectedLanguage: _selectedLanguage, // Pass the current selected language
      onLanguageSelected: (language) {
        setState(() {
          _selectedLanguage = language; // Update the selected language
        });
        _saveLanguage(language); // Optionally save the language choice

        // You can also call setState() here to "refresh" the widget if needed
        // setState(() {}); // This is unnecessary because you're already calling setState above
      },
    );
  },
  child: ListTile(
    contentPadding: EdgeInsets.only(left: 30.w), // Responsive padding
    leading: Icon(
      Icons.language,
    ...
    title: Text(
      'language'.tr(), // Translate the 'language' key using EasyLocalization
      style: GoogleFonts.prompt(
