        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(width: 8.w),
              Text(
                "ได้ ${product.title} พ้อยท์", //ได้ ${product.title} พ้อยท์
                style: TextStyle(
                  fontSize: 24.sp,
                  fontWeight: FontWeight.w600,
                  color: Colors.black,
  ...
  Future<void> _handlePurchase(BuildContext context, String title) async {
    ...
    try {
      ...
      if (paymentProvider.errorMessage == null) {
        NotificationDialog(
          context: context,
          text: "ได้รับพ้อยท์จำนวน $title พ้อยท์", //ได้รับพ้อยท์จำนวน $title พ้อยท์
          onPressed: () {},
