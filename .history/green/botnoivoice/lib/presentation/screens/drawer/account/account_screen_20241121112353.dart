...
class _AccountScreenState extends State<AccountScreen> {
  ...
  void _copyUID() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('app_drawer.uid_copy_success'.tr()๗), //UID คัดลอกเรียบร้อยแล้ว
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  "เข้าสู่ระบบด้วย", //เข้าสู่ระบบด้วย
                  style: GoogleFonts.prompt(
                    fontSize: 14.sp,
