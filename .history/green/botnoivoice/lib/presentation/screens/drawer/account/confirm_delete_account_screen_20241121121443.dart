...
class _ConfirmDeleteAccountScreenState
  ...
  Future<void> _deleteAccount() async {
    ...
    if (!emailProvider.isLoggedIn ||
      ...
      NotificationDialog(
        context: context,
        text: 'ไม่สามารถลบบัญชีได้. คุณไม่ได้เข้าสู่ระบบด้วยอีเมล', //ไม่สามารถลบบัญชีได้. คุณไม่ได้เข้าสู่ระบบด้วยอีเมล
    ...
    if (!isPasswordValid) {
      NotificationDialog(
        context: context,
        text: emailDeleteAccountProvider.errorMessage ?? 'รหัสผ่านไม่ถูกต้อง', //รหัสผ่านไม่ถูกต้อง
      ).showErrorModal(context);
      setState(() {
        isDeleting = false;
      });
