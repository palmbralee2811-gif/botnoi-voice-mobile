  ...
  void submitUsernameChangeRequest() async {
    ...
    if (_formKey.currentState != null && _formKey.currentState!.validate()) {
      ...
      if (errorMessage != null && errorMessage.isNotEmpty) {
        ...
        NotificationDialog(
          context: context,
          text: 'app_drawer.username_changed_successfully'.tr(), //ตั้งชื่อผู้ใช้งานใหม่สำเร็จ
          onPressed: () async {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GradientTextAlign(
                    'app_drawer.change_username'.tr(), //เปลี่ยนชื่อผู้ใช้
                  ...
                  SizedBox(height: 8.h),
                  GradientTextAlign(
                    'app_drawer.set_new_username_for_login'.tr(), //ตั้งชื่อผู้ใช้งานใหม่สำหรับใช้ในการเข้าสู่ระบบ
                    gradient: const LinearGradient(
                      colors: [
                        Color(0xFF9340FF),
                        Color(0xFF34BDFA),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'app_drawer.new_username'.tr(), //ชื่อผู้ใช้งานใหม่
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'app_drawer.please_enter_your_username'.tr(); //โปรดใส่ชื่อผู้ใช้งานของคุณ
                      }
                      if (!isValidUsername(value.trim())) {
                        return 'app_drawer.invalid_username'.tr(); //ชื่อผู้ใช้งานไม่ถูกต้อง กรุณาใช้ตัวอักษร a-z, A-Z, ตัวเลข และเครื่องหมาย _ หรือ -
                      }
                      return null;
                    },
                  ),
                  ...
                  TextFormField(
                    ...
                    style:
                        TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w400),
                    decoration: InputDecoration(
                      labelText: 'app_drawer.confirm_new_username'.tr(), //ยืนยันชื่อผู้ใช้งานใหม่
                      labelStyle: TextStyle(
                          fontSize: 16.sp, fontWeight: FontWeight.w400),
                      fillColor: Colors.white,
                      filled: true,
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'app_drawer.please_confirm_your_username'.tr(); //โปรดยืนยันชื่อผู้ใช้งานของคุณ
                      }
                      if (!isValidUsername(value.trim())) {
                        return 'app_drawer.invalid_username'.tr(); //ชื่อผู้ใช้งานไม่ถูกต้อง กรุณาใช้ตัวอักษร a-z, A-Z, ตัวเลข และเครื่องหมาย _ หรือ -
                      }
                      if (value != _usernameController.text) {
                        return 'app_drawer.usernames_must_match'.tr(); //ชื่อผู้ใช้งานทั้งสองช่องต้องตรงกัน
                      }
                      return null;
                    },
                  ),
                  SizedBox(height: 16.h),
                  GradientTextButton(
                    text: 'app_drawer.confirm'.tr(), //ยืนยัน
                    onPressed: () {
