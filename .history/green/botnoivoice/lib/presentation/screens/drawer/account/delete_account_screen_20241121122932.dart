          ...
          children: [
            ...
            Center(
              child: Column(
                children: [
                  GradientTextAlign(
                    'app_drawer.confirm_account_deletion'.tr(), //หากยืนยันที่จะลบบัญชีต่อ กรุณากดปุ่ม
                    gradient: const LinearGradient(
                      colors: [
                        Color(0xFF9340FF),
                        Color(0xFF34BDFA),
                  ...
                  GradientTextAlign(
                    'app_drawer.confirm_account_deletion_below'.tr(), //"ยืนยันลบบัญชี" ด้านล่าง
                    gradient: const LinearGradient(
                      colors: [
                        Color(0xFF9340FF),
                        Color(0xFF34BDFA),
            ...
            SizedBox(height: 16.h),
            GradientTextButton(
              text: 'app_drawer.cancel'.tr(), //ยกเลิก
              onPressed: () {
                Navigator.pop(context);
              },
            ),
            ...
            ElevatedButton(
              ...
              child: Center(
                child: Text(
                  'app_drawer.confirm_account_deletion_button'.tr(),
                  style: TextStyle(
                    fontSize: 16.sp,
                    fontWeight: FontWeight.w600,
                    color: kDark,
